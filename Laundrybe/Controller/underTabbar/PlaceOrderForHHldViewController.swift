//
//  PlaceOrderForHHldViewController.swift
//  Laundrybe
//
...
class PlaceOrderForHHldViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, NVActivityIndicatorViewable {
    ...
    override func viewDidLoad() {
        ...
        savingSelections()
          ...
          globalLabel.sharedInstance.dataKey.append(idVal + "H")
    ...
    func sendTotalDataInfo() {
        ...
        let nonCat = globalLabel.sharedInstance.placeOrderCombined.filter{ $0.filterCode != idVal + "HHL"}
        ...
        for i:Int in 0 ..< priceDataList.count {
            ...
            if NewCountValue.isEmpty{
                ...
                if Int(priceDataList[i].countLabel) > 0 {
                    ...
                    auxPlaceOrder.filterCode = idVal + "HHL"
    ...
    func savingSelections() {
        if let NewCount = UserDefaults.standard.array(forKey:  idVal + "H") as? [Int] {
    ...
    func callingApi() {
        ...
        providerApi.getPriceListForHouseHold { (result) in
            switch result {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        print("GogbalvalueW= \(globalLabel.sharedInstance.totvalue)")
...
//    }
    ...
    func savingSelectData() {
        ...
        UserDefaults.standard.set(data, forKey:  idVal + "H")
        
        print("Keys = \( globalLabel.sharedInstance.dataKey.map{$0})")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.genderImage.image = UIImage(named: "vectorBed")
