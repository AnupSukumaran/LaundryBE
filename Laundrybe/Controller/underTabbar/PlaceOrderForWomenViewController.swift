//
//  PlaceOrderForWomenViewController.swift
//  Laundrybe
//
...
class PlaceOrderForWomenViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, NVActivityIndicatorViewable {
    ...
    override func viewDidLoad() {
        ...
        savingSelections()
         ...
         globalLabel.sharedInstance.dataKey.append( idVal + "W")
    ...
    func savingSelections() {
        if let NewCount = UserDefaults.standard.array(forKey:  idVal + "W") as? [Int] {
    ...
    func callingApi() {
        ...
        providerApi.getPriceListForWomen { (result) in
            switch result {
...
//    }
    ...
    @IBAction func sendTotalPrice(_ sender: Any) {
    ...
    func sendTotalDataInfo() {
        ...
        let nonCat = globalLabel.sharedInstance.placeOrderCombined.filter{ $0.filterCode != idVal + "women"}
            ...
            if NewCountValue.isEmpty{
                ...
                if Int(priceDataList[i].countLabel) > 0 {
                    ...
                    auxPlaceOrder.serviceType = priceDataList[i].service
                     auxPlaceOrder.filterCode = idVal + "women"
    ...
    func savingSelectData() {
        ...
        UserDefaults.standard.set(data, forKey:  idVal + "W")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.genderImage.image = UIImage(named: "vectorWomen")
